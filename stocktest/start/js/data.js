...
const qnaList = [
  {
    q: '1. 몇 년 전에 없어져도 되는 여윳돈으로 넣었던 투자 종목에서 <br> 1억이라는 돈을 벌게 되었다. 이후 나의 태도는?',
    a: [
  ...
  {
    q: '2. 나는 경제에 관심이 많은 편이라, 관련 기사나 소식을 자주 보는 편이다. ',
    a: [
  ...
  {
    q: '3. 친구들이랑 게임을 하러갔다. 그때 친구가, “진 사람이 밥 사기 내기 콜?” 그때 나의 반응은?',
    a: [
  ...
  {
    q: '4. 투자에 관심이 많은 나는, 투자 동아리원들과 모의투자 대회에 나가게 되었다. 투자 계획을 짤 때 나의 자세는?',
    a: [
  ...
  {
    q: '5. 나는 ETF, 채권, 주식, 금리, 재무제표와 같은 금융 기본 용어를 잘 알고 있다',
    a: [
  ...
  {
    q: '6. 내가 투자한 코인 종목이 급떡상하고 있다. 이때 나의 선택은?',
    a: [
  ...
  {
    q: '9. 갑자기 내가 투자한 종목이 급변하고 있다!!! 이때 나는?',
    a: [
  ...
  {
    q: '10. 분석을 열심히 한 뒤에 결국 특정 종목에 투자를 했다 ',
    a: [
